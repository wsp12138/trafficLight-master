...
class DRQN:
    ...
    def init_hidden(self):
        ...
        self.eval_hidden = torch.zeros((self.batch_size,self.hidden_dim))
        self.target_hidden = torch.zeros((self.batch_size,self.hidden_dim))
    ...
    def update(self, transitions,update_target):
        ...
        q_values,self.eval_hidden = self.policy_net(o,self.eval_hidden)
        q_values=q_values.gather(dim=1, index=u)

        next_q_values,self.target_hidden = self.target_net(o_next,self.target_hidden)
